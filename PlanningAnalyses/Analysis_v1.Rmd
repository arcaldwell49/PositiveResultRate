...
Below, we have incorporated this prior (`prior_1`) into a simulated dataset and then analyzed this with the `brm` function (saved as `m_test`).
...
First, this analysis, under the previously stated assumptions, would be able to yield a Bayes Factor in favor of our hypothesis `r round(mean(hyp_df$Evid.Ratio > 3)*100,2)`% of the time. Below is a plot of the simulated Bayes Factors (excluding Bayes Factors > 100).
