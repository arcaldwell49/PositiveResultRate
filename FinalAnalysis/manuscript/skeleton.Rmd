...
abstract: 'Scientists rely upon an accurate scientific literature in order to build
  ...
  particular, 3 recent have indicated a implausibly high rate of studies with positive
...
```{r fig2, fig.cap="Figure 2", out.width = "90%"}
...
Clinical trials (N = 40) had lower rates of reported support for the hypothesis, 64\% [42.5, 82], but similar hypothesis testings rates, 67.5\% [50.8, 81.4], compared to the rest of the analyzed manuscripts. Despite guidelines requiring sample size justifications, only 62.5\% [45.8, 77.3] reported a sample size justification. In addition, despite regulations that require clinical trial registration, only 57.5\% [40.9, 72.9] reported clinical trial registration or preregistration documentation.
