...
- name: Christopher McCrum
  affiliation: '7'
- name: Whitley C. Atkins
  affiliation: '8'
- name: Jennifer Murphy
  affiliation: '3'
- name: Claudia Romero Medina
  affiliation: '2'
- name: Sena Harlley
  affiliation: '2'
...
address:
- code: '1'
  address: Cumming School of Medicine, University of Calgary, Calgary, AB, Canada.
- code: '2'
  address: Department of Kinesiology, California State University - East Bay, Hayward, CA, USA.
- code: '3'
  address: Centre of Applied Science for Health, Technological University Dublin, Tallaght, Dublin, Ireland. 
- code: '4'
  address: Setanta College, Thurles Chamber of Commerce, Tipperary, Ireland. 
- code: '5'
  address: Department of Training and Exercise Science, Faculty of Sport Science, Ruhr University Bochum, Bochum, Germany. 
- code: '6'
  address: Department of Cardiology and Angiology, Contilia Heart and Vascular Center, Essen, Germany
- code: '7'
  address: Department of Nutrition and Movement Sciences, NUTRIM School of Nutrition and Translational Research in Metabolism, Maastricht University, Maastricht, The Netherlands. 
- code: '8'
  address: Department of Health, Human Performance and Recreation, University of Arkansas, Fayetteville, AR, USA.
- code: '9'
  address: Society for Transparency, Openess, and Replication in Kinesiology, Hayward, CA, USA.
corresp_author_name: Aaron R. Caldwell
corresp_author_email: aaron@storkinesiology.org
...
citation: "Twomey et al. (2021). The Nature of Our Literature\\: A Registered Report on the Positive Result Rate and Reporting Practices in Kinesiology. \\textit{Communications in Kinesiology}. doi: 10.51224/cik.v1i3.43"
editor: "Zachary Zenko"
rise: true
...
```{r fig3, fig.cap="Figure 3. The breakdown, by discipline, for A) indication of whether a hypothesis was tested B) level of reported support for a hypothesis,  and C) the estimated total sample size (grey bands indicate 95\\% confidence intervals).", out.width = "100%"}
...
Following Stage 1 in-principle acceptance, the authors agreed to preregistration of the approved protocol on the Open Science Framework. The IPA registration can be found here: https://osf.io/3pqr7.
